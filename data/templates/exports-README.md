...
- Required: required
- Meaning: Must be export in this template. The other direction has its own file so a mistake cannot put exports into imports.
- Accepted values: one of export
- Example: `export`
